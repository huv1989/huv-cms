...
public class SysConstants
{
	 ...
	 * 模版html路径
	 */
	public static final String			TEMPLATE_FOLDER				= "pager/biz-logic/template";
	/**
	 * 正式生成路径
	 */
	public static final String	        HTML_STATIC_FOLDER        = "pager/biz-logic/static";
	/**
	 * 临时html路径
	 */
	public static final String	        HTML_TEMP_FOLDER        = "pager/biz-logic/temp";
}
