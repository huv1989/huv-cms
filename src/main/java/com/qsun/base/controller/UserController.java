...
import com.qsun.base.model.SysUserPostModel;
import com.qsun.base.model.SysUserRoleModel;
...
public class UserController extends BaseController
{
	...
	public void roleChecked()
	{
		...
		userRole.set("userID", getPara("userID"));
		userRole.set("roleID", getPara("roleID"));
