...
import com.qsun.base.model.SysMenusModel;
...
public class MenuController extends BaseController
{
	...
	public void add()
	{
		...
		if (menu.save())
		{
			...
			setAttr("menuName", menu.get("menuName"));
			setAttr("remark", menu.get("remark"));
			setAttr("parentID", menu.get("parentID"));
	...
	public void update()
	{
		...
		if (menu.get("id") != null && menu.update())
		{
			...
			boolean isParent = menu.get("isParent").toString() .equals("1")?true:false;
